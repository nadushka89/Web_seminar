...
$workexperience = [
    [
        'name_work' => 'Лежание на подоконнике',
        'date' => 'Mar 2015 -',
        'description' => 'Я просто обажаю лежать на подоконнике,особенно,когда светит
        солнышко и поют птички',
    ],
    [
        'name_work' => 'Мырлыканье',
        'date' => 'Mar 2015-Apr 2022',
        'description' => 'Обажаю когда меня гладят,поэтому 
        всегда мурлыкаю,сколько себя помню. Мур.',
    ],
    [
        'name_work' => 'Когтеточка',
        'date' => 'Mar 2017-Apr 2021',
        'description' => 'В совершенстве владею когтеточкой, последнее время обажаю еще и стулья, только никому.',
    ],
]
;
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><b><?php echo $workexperience[0]['name_work']; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workexperience[0]['date']; ?><span
                class="w3-tag w3-teal w3-round">Current</span></h6>
            <p><?php echo $workexperience[0]['description']; ?></p>
            <hr>
           <?php for ($i = 1; $i < count($workexperience); $i++): ?>
                <h5 class="w3-opacity"><b><?php echo $workexperience[$i]['name_work']; ?> </b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workexperience[$i]['date']; ?></h6>
